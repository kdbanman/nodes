...
public class ViewVocabulary {
    ...
    private static Model nodeDescription(Node node) {
        ...
        // use Node's RDFNode as the object of description triples
        //TODO RDFNode obj = node.getRDFNode();
    ...
    private static ReifiedStatement reifyStatement(Model toAugment, Statement toReify) {
        return toAugment.createReifiedStatement(uri + "Statement_" + UUID.randomUUID().toString(), toReify);
    }
